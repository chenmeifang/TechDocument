...
# [! 9. any和unknown的区别](https://www.bilibili.com/video/BV1EU4y1C7kW?spm_id_from=333.788.player.switch&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

# 10. TS与JS的区别

### 1. **类型系统**
- **TypeScript**: TypeScript 是 JavaScript 的超集，它最大的特点是支持**静态类型检查**。开发者可以在编写代码时为变量、函数、对象等定义明确的类型，这样在编译时可以检测类型错误。
...
- **JavaScript**: JavaScript 是一种**动态类型语言**，变量类型在运行时才会确定，类型检查在运行时进行。这可能会导致更多的运行时错误。
