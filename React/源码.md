...
<img src="源码.assets/image-20240411083403015.png" alt="image-20240411083403015" style="zoom:80%;" />
...
<img src="源码.assets/image-20240312131700124.png" alt="image-20240312131700124" style="zoom: 80%;" />

#### 5.1.1.1 isValidContainer

<img src="源码.assets/image-20240312171043554.png" alt="image-20240312171043554" style="zoom: 50%;" />

#### 5.1.1.2 legacyRenderSubtreeIntoContainer
...
<img src="源码.assets/image-20240312171359642.png" alt="image-20240312171359642" style="zoom: 60%;" />                   <img src="源码.assets/image-20240312172937768.png" alt="image-20240312172937768" style="zoom:50%;" />

**223行的container是一个dom对象：<div id="root"></div>**

<img src="源码.assets/image-20240312174525736.png" alt="image-20240312174525736" style="zoom:55%;" />         <img src="源码.assets/image-20240312174627588.png" alt="image-20240312174627588" style="zoom:55%;" />

#### 5.1.2.2 legacyCreateRootFromDOMContainer

**创建FiberRoot以及RootFiber**

<img src="源码.assets/image-20240411082032948.png" alt="image-20240411082032948" style="zoom:45%;" />

#### 5.1.2.3 createLegacyRoot

<img src="源码.assets/image-20240411082407187.png" alt="image-20240411082407187" style="zoom: 38%;" />   <img src="源码.assets/image-20240312175400531.png" alt="image-20240312175400531" style="zoom:55%;" />

==什么是LegacyRoot？==

#### 5.1.2.4 ReactDOMBlockingRoot

<img src="源码.assets/image-20240312180256363.png" alt="image-20240312180256363" style="zoom:50%;" />

#### 5.1.2.5 createRootImpl

<img src="源码.assets/image-20240312180412243.png" alt="image-20240312180412243" style="zoom:50%;" />

#### 5.1.2.6 createContainer

<img src="源码.assets/image-20240312180707801.png" alt="image-20240312180707801" style="zoom:50%;" />

#### 5.1.2.7 createFiberRoot

<img src="源码.assets/image-20240312180813852.png" alt="image-20240312180813852" style="zoom:50%;" />              <img src="源码.assets/image-20240312180931799.png" alt="image-20240312180931799" style="zoom:55%;" />

### 5.1.4 获取rootFiber.child实例对象

### [5.1.5 updateContainer](https://www.bilibili.com/video/BV13j411D7K6?p=12&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

在updateContainer方法中，所做的最核心的事情：**创建一个任务对象。**当前所做的事情是初始化渲染，它会把初始化渲染当做一个任务去执行

### 5.1.6 scheduleWork

https://www.bilibili.com/video/BV13j411D7K6?p=13&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e
...
![image-20240409212421082](源码.assets/image-20240409212421082.png)

### [5.1.9 performUnitOfWork](https://www.bilibili.com/video/BV13j411D7K6?p=16)

### [5.1.10 reconcileChildren](https://www.bilibili.com/video/BV13j411D7K6?p=17&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

### [5.1.11 completeUnitOfWork](https://www.bilibili.com/video/BV13j411D7K6?p=20&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)
