 ...
 * @param {*} workInProgress 父级Fiber
 * @param {*} nextChildren 子级vdom对象。我们要构建的就是子级vdom对象所对应的Fiber对象
...
function updateHostRoot(current, workInProgress, renderExpirationTime) {
  ...
  // 再通过workInProgress.memoizedState获取到里面的element
  // 要更新的内容就是element 就是rootFiber的子元素
