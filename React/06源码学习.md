...
function beginWork(
  ...
  // 看当前Fiber对象是什么类型，因为不同的Fiber对象获取子级元素的方式不同
...
![image-20240906140621430](06源码学习.assets/image-20240906140621430.png)
...
![image-20240906141500478](06源码学习.assets/image-20240906141500478.png)
...
# 8. firstEffect，nextEffect，lastEffect三个属性的具体构建和使用
