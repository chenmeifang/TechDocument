...
前端的 CI/CD 是指在前端开发中应用的 **持续集成（Continuous Integration, CI）** 和 **持续交付/持续部署（Continuous Delivery/Continuous Deployment, CD）** 流程，旨在提高开发效率、自动化发布流程，并确保代码质量和稳定性。

### 1. **CI（持续集成）**
持续集成是指开发团队频繁地将代码集成到主分支中，并自动运行一系列测试和检查来确保代码的质量和功能。通常，这包括：
- **代码提交（commit/push）后自动触发构建流程**，如编译、打包等。
- **自动化测试**，运行单元测试、集成测试、端到端测试等，确保代码没有引入错误。
- **代码质量检查**，如静态分析、代码风格检查（Linting）、依赖检查等。

对于前端项目，CI 可以包括：
- 运行 JavaScript/TypeScript 代码的构建工具（如 Webpack、Vite）进行打包。
- 运行 Jest、Mocha 等工具进行测试。
- 使用 ESLint、Prettier 进行代码质量检查。

### 2. **CD（持续交付/持续部署）**
CD 分为两种形式：持续交付和持续部署。

- **持续交付（Continuous Delivery）**：代码通过 CI 流程后，自动构建、测试并准备好发布版本，但发布到生产环境的过程仍然需要手动触发或批准。主要目的是确保代码在任何时候都可以发布。
  
- **持续部署（Continuous Deployment）**：与持续交付类似，但整个发布流程是全自动的，当代码通过所有测试和检查后，直接部署到生产环境，无需手动干预。

对于前端项目，CD 可以包括：
- **自动化构建**：将前端项目（如 React、Vue、Angular 等）打包成生产环境可用的文件。
- **部署到服务器**：将打包好的文件上传到生产服务器、CDN 或云平台（如 Netlify、Vercel、AWS S3 等）。
- **缓存刷新**：发布新版本时刷新缓存、更新静态资源的版本号。

### CI/CD 流程示例：
1. **开发人员提交代码**到 Git 仓库（如 GitHub、GitLab）。
2. **CI 流程启动**：
   - 自动构建代码。
   - 运行测试。
   - 进行代码质量检查。
3. **CD 流程启动**（如果测试通过）：
   - 自动将项目部署到开发环境或预生产环境。
   - 如果使用持续部署，代码还会自动发布到生产环境。

### 工具和平台：
- **CI/CD 平台**：Jenkins、GitHub Actions、GitLab CI、Travis CI、CircleCI 等。
- **前端部署工具**：Netlify、Vercel、AWS Amplify、GitHub Pages 等。

总结来说，前端的 CI/CD 是自动化开发、测试、构建和部署流程的结合，可以显著提升代码交付效率，并降低出错的可能性。

# 1. Git概述

# [2. Git安装](https://www.bilibili.com/video/BV1nY411T747/?p=2&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

![image-20240911111906336](10 工程化和自动化技术.assets/image-20240911111906336.png)

# 3. Git仓库创建

![image-20240911112128142](10 工程化和自动化技术.assets/image-20240911112128142.png)

# [1. 课程介绍](https://www.bilibili.com/video/BV12y4y1M7jU/?spm_id_from=333.337.search-card.all.click&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

那些大厂们，天天DevOps、持续集成的？到底在讲些什么？
...
![960320-643ea99a49018223 (2)](10 工程化和自动化技术.assets/960320-643ea99a49018223 (2).webp)
...
# [2. 持续集成](https://www.bilibili.com/video/BV12y4y1M7jU/?p=2&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-c319499f20422805.png?imageMogr2/auto-orient/strip|imageView2/2/w/720/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-368e86c70ea54a06.png?imageMogr2/auto-orient/strip|imageView2/2/w/720/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-2ec4be226d5f55e5.png?imageMogr2/auto-orient/strip|imageView2/2/w/720/format/webp)

实际上，持续部署意味着开发人员对应用的更改在编写后的几分钟内就能生效（假设它通过了自动化测试）。这更加便于持续接收和整合用户反馈。总而言之，所有这些 CI/CD 的关联步骤都有助于降低应用的部署风险，因此更便于以小件的方式（而非一次性）发布对应用的更改。不过，由于还需要编写自动化测试以适应 CI/CD 管道中的各种测试和发布阶段，因此前期投资还是会很大。

持续部署则是在持续交付的基础上，把部署到生产环境的过程`自动化`。

## [2.2 持续集成组成要素](https://www.bilibili.com/video/BV12y4y1M7jU/?p=3&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)
...
> 这也是传统的瀑布式开发模型，请参考：[软件开发模式对比(瀑布、迭代、螺旋、敏捷)](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.cnblogs.com%2F-OYK%2Farchive%2F2012%2F10%2F08%2F2714669.html)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-01e5d20daf0bf463.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
### [2.4.3 解决的问题](https://www.bilibili.com/video/BV12y4y1M7jU/?p=4&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)
...
### [2.4.5 最佳实践](https://www.bilibili.com/video/BV12y4y1M7jU/?p=5&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)
...
- 使用编码最佳实践，例如结对编程。
  ...
  > **Pair programming** is an [agile software development](https://links.jianshu.com/go?to=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FAgile_software_development) technique in which two [programmers](https://links.jianshu.com/go?to=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FComputer_programmer) work together at one workstation. One, the *driver*, writes [code](https://links.jianshu.com/go?to=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FSource_code) while the other, the *observer* or *navigator*,[[1\]](https://links.jianshu.com/go?to=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FPair_programming%23cite_note-1) [reviews](https://links.jianshu.com/go?to=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FCode_review) each line of code as it is typed in. The two programmers switch roles frequently.
  >
...
## [2.5 效率工具对比](https://www.bilibili.com/video/BV12y4y1M7jU/?p=6&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

![img](https:////upload-images.jianshu.io/upload_images/960320-aa09a78c14da1d4c.png?imageMogr2/auto-orient/strip|imageView2/2/w/1024/format/webp)

[点击查看](#复杂的DevOps相关工具)效率工具

**1. Jenkins**

> Jenkins，原名Hudson，2011年改为现在的名字，它 是一个开源的实现持续集成的软件工具。官方网站：[http://jenkins-ci.org/](https://links.jianshu.com/go?to=http%3A%2F%2Fjenkins-ci.org%2F)。
>
...
在GitHub或Bitbucket上的软件存储库被授权并作为项目添加到[circleci.com之后](https://links.jianshu.com/go?to=https%3A%2F%2Fcircleci.com%2F)，每个代码更改都会在干净的容器或VM中触发自动化测试。
...
![img](https:////upload-images.jianshu.io/upload_images/960320-1c41304868f99556.png?imageMogr2/auto-orient/strip|imageView2/2/w/1031/format/webp)

CirCle CI的价格：

![img](https:////upload-images.jianshu.io/upload_images/960320-e65edb41af23b7e9.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
# [3. Jenkins](https://www.bilibili.com/video/BV12y4y1M7jU/?p=7&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)

## 3.1 使用简介

Jenkins是开源CI&CD软件领导者， 提供超过1000个插件来支持构建、部署、自动化， 满足任何项目的需要。

![img](https:////upload-images.jianshu.io/upload_images/960320-7bd00f28f978a653.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-0194d116e368bb12.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

Jenkins的界面

![img](https:////upload-images.jianshu.io/upload_images/960320-f915d27b0f2e776e.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

任务详情页面

![img](https:////upload-images.jianshu.io/upload_images/960320-bc21661413fbcc0a.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
1. 环境要求
   ...
   - 需要安装以下软件：
     ...
     - [Docker](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.docker.com%2F) （导航到网站顶部的Get Docker链接以访问适合您平台的Docker下载）

2. 常规安装

   - 安装JDK

     [官方地址](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.oracle.com%2Ftechnetwork%2Fjava%2Fjavase%2Fdownloads%2Fjdk8-downloads-2133151.html)
   ...
   - 安装Jenkins
     ...
     下载Jenkins最新的war包：[Latest](https://links.jianshu.com/go?to=http%3A%2F%2Fmirrors.jenkins.io%2Fwar-stable%2Flatest%2Fjenkins.war)
     ...
     就嗯可以打开，[http://localhost:8080](https://links.jianshu.com/go?to=http%3A%2F%2Flocalhost%3A8080)了
...
3. 使用Docker安装
   ...
   - 配置Docker镜像加速，使用阿里云[容器加速服务](https://links.jianshu.com/go?to=https%3A%2F%2Fcr.console.aliyun.com%2F%3Fspm%3Da2c4e.11153940.blogcont29941.9.52027e29w2jv9P)
...
- 安装Jenkins
  ...
  **版本选择：**
  ...
  Jenkins: [https://hub.docker.com/r/jenkins/jenkins/](https://links.jianshu.com/go?to=https%3A%2F%2Fhub.docker.com%2Fr%2Fjenkins%2Fjenkins%2F)

  Jenkins with Blue Ocean: [https://hub.docker.com/r/jenkinsci/blueocean](https://links.jianshu.com/go?to=https%3A%2F%2Fhub.docker.com%2Fr%2Fjenkinsci%2Fblueocean)

  > Blue Ocean 重新思考Jenkins的用户体验，从头开始设计[Jenkins Pipeline](https://links.jianshu.com/go?to=https%3A%2F%2Fjenkins.io%2Fzh%2Fdoc%2Fbook%2Fpipeline%2F), 但仍然与自由式作业兼容，Blue Ocean减少了混乱而且进一步明确了团队中每个成员 Blue Ocean 的主要特性包括：
  >
...
![img](https:////upload-images.jianshu.io/upload_images/960320-700b8c73e51b7747.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

![img](https:////upload-images.jianshu.io/upload_images/960320-919d8c35944f17a4.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

关于官方所有的镜像列表：

[http://mirrors.jenkins-ci.org/status.html](https://links.jianshu.com/go?to=http%3A%2F%2Fmirrors.jenkins-ci.org%2Fstatus.html)
...
2. 用户权限配置
   ...
   - 矩阵权限的配置
   - 添加管理员用户所有的权限
   - 添加[Authorize Project](https://links.jianshu.com/go?to=https%3A%2F%2Fwiki.jenkins-ci.org%2Fdisplay%2FJENKINS%2FAuthorize%2BProject%2Bplugin)插件，并且在系统管理中进行配置。配置逻辑，就给用户当前项目的矩阵权限！
...
- Publish Over FTP
  ...
  [图片上传失败...(image-25e134-1586962416037)]
...
![img](https:////upload-images.jianshu.io/upload_images/960320-2c9b3aa885922acc.png?imageMogr2/auto-orient/strip|imageView2/2/w/1080/format/webp)

image.png

​        [https://plugins.jenkins.io/performance](https://links.jianshu.com/go?to=https%3A%2F%2Fplugins.jenkins.io%2Fperformance)
...
​        [https://github.com/timols/jenkins-gitlab-merge-request-builder-plugin](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Ftimols%2Fjenkins-gitlab-merge-request-builder-plugin)

- JIRA Plugin

​        JIRA Plugin 可以让 Jenkins 任务和 JIRA 集成起来，这样项目管理者可以通过 JIRA 了解项目进度，开发者也可以通过该插件直接更改 JIRA 上的 issue 状态。

​        [https://plugins.jenkins.io/jira](https://links.jianshu.com/go?to=https%3A%2F%2Fplugins.jenkins.io%2Fjira)
...
​        [https://github.com/jenkinsci/kubernetes-plugin](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fjenkinsci%2Fkubernetes-plugin)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-809410e3224adea1.png?imageMogr2/auto-orient/strip|imageView2/2/w/1080/format/webp)

​        [https://github.com/jenkinsci/build-pipeline-plugin](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fjenkinsci%2Fbuild-pipeline-plugin)

## [3.4 配置自动化任务](https://www.bilibili.com/video/BV12y4y1M7jU/?p=10&spm_id_from=pageDriver&vd_source=a7089a0e007e4167b4a61ef53acc6f7e)
...
首先，访问官方网站 [travis-ci.org](https://links.jianshu.com/go?to=https%3A%2F%2Ftravis-ci.org%2F)，点击右上角的个人头像，使用 Github 账户登入 Travis CI。

会进入到授权页面，这里跟微博、QQ是一回事，主要是读取你的用户信息。

![img](https:////upload-images.jianshu.io/upload_images/960320-0e9ddb3d1daf538c.png?imageMogr2/auto-orient/strip|imageView2/2/w/583/format/webp)

image.png

这里第二步在，`Dashboard`这个选项卡中，点击`Activate`这个按钮

![img](https:////upload-images.jianshu.io/upload_images/960320-60789a1cf2644bf8.png?imageMogr2/auto-orient/strip|imageView2/2/w/1171/format/webp)

image.png

完了之后，Dashboard会列出所有Github中有`.travis.yml`配置文件的仓库：

![img](https:////upload-images.jianshu.io/upload_images/960320-6449a4461223af80.png?imageMogr2/auto-orient/strip|imageView2/2/w/1127/format/webp)

image.png

Travis 会列出 Github 上面你的所有仓库，以及你所属于的组织。此时，选择你需要 Travis 帮你构建的仓库，打开仓库旁边的开关。一旦激活了一个仓库，Travis 会监听这个仓库的所有变化。

![img](https:////upload-images.jianshu.io/upload_images/960320-237d956a4fd8c411.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

image.png

- `Settings`中用于配置项目的构建条件

![img](https:////upload-images.jianshu.io/upload_images/960320-f25d9eb86c31252e.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

image.png

- `Requests`可以查看构建记录

![img](https:////upload-images.jianshu.io/upload_images/960320-3839240ee8c081d8.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-6fa91a2f5373683e.png?imageMogr2/auto-orient/strip|imageView2/2/w/1054/format/webp)
...
- [Auto-deploying built products to gh-pages with Travis](https://links.jianshu.com/go?to=https%3A%2F%2Fgist.github.com%2Fdomenic%2Fec8b0fc8ab45f39403dd)
- [SSH deploys with Travis CI](https://links.jianshu.com/go?to=https%3A%2F%2Foncletom.io%2F2016%2Ftravis-ssh-deploy%2F)
- [持续集成服务 Travis CI 教程](https://links.jianshu.com/go?to=http%3A%2F%2Fwww.ruanyifeng.com%2Fblog%2F2017%2F12%2Ftravis_ci_tutorial.html)
...
1. 注册 CircleCI
   ...
   打开 [CircleCI](https://links.jianshu.com/go?to=https%3A%2F%2Fcircleci.com%2F) 官方网站，使用您的GitHub帐户登录。

![img](https:////upload-images.jianshu.io/upload_images/960320-5eace424cb6fa0e7.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)

image.png

进行授权：

![img](https:////upload-images.jianshu.io/upload_images/960320-4b9189b707d86ef2.png?imageMogr2/auto-orient/strip|imageView2/2/w/590/format/webp)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-7262f44aeb73dd26.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
1. 编写 config.yml
   ...
   官方参考文档：[https://circleci.com/docs/2.0/configuration-reference/#version](https://links.jianshu.com/go?to=https%3A%2F%2Fcircleci.com%2Fdocs%2F2.0%2Fconfiguration-reference%2F%23version)
...
![img](https:////upload-images.jianshu.io/upload_images/960320-6f14a2b9950fc61d.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
[Shell脚本———— /dev/null 2>&1详解](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.cnblogs.com%2Ftinywan%2Fp%2F6025468.html)

[shell中>/dev/null 2>&1](https://links.jianshu.com/go?to=https%3A%2F%2Fblog.csdn.net%2Fjackyechina%2Farticle%2Fdetails%2F54582146)

[Linux Shell 1>/dev/null 2>&1 含义](https://links.jianshu.com/go?to=https%3A%2F%2Fblog.csdn.net%2Fithomer%2Farticle%2Fdetails%2F9288353)
...
2. 微服务+无服务的应用模式
   ...
   **无服务器风格的架构（Serverless architecture）**把DevOps技术在微服务领域的应用推向极致。当应用程序执行环境的管理被新的编程模型和平台取代后，团队的交付生产率得到了进一步的提升。一方面它免去了很多环境管理的工作，包括设备、网络、主机以及对应的软件和配置工作，使得软件运行时环境更加稳定。另一方面，它大大降低了团队采用DevOps的技术门槛。
   ...
   在微服务端到端交付流程上，Netflix开源了自家的[Spinnaker](https://links.jianshu.com/go?to=http%3A%2F%2Fwww.spinnaker.io%2F)，Netflix作为微服务实践的先锋，不断推出新的开源工具来弥补社区中微服务技术和最佳实践的缺失。而[Spring Cloud](https://links.jianshu.com/go?to=http%3A%2F%2Fprojects.spring.io%2Fspring-cloud%2F)则为开发者提供了一系列工具，以便他们在所熟悉的Spring技术栈下使用这些服务协调技术(coordination techniques)，如服务发现、负载均衡、熔断和健康检查。

3. 人工智能领域的应用

   DevOps的最早实践来自于互联网企业的Web应用，相应的思想被引入企业级应用并促进了一系列工具的发展。在人工智能领域，[TensorFlow](https://links.jianshu.com/go?to=https%3A%2F%2Fwww.tensorflow.org%2F)就是这样一个例子，它可以有多种DevOps友好的安装和部署方式 ，例如采用Docker进行部署。
...
5. Windows平台下.net的技术潜力巨大
   ...
   长期以来，Windows和.NET平台下的DevOps一直都是一个被低估的领域。一方面，社区缺乏对 Windows Server平台的兴趣。另一方面，[Windows Server却有接近90%的市场占用率](https://links.jianshu.com/go?to=https%3A%2F%2Fcommunity.spiceworks.com%2Fnetworking%2Farticles%2F2462-server-virtualization-and-os-trends)，在Web服务器领域则有[33.5%的市场占有率](https://links.jianshu.com/go?to=https%3A%2F%2Fw3techs.com%2Ftechnologies%2Foverview%2Foperating_system%2Fall)。
...
![img](https:////upload-images.jianshu.io/upload_images/960320-5fcd75fde372446d.png?imageMogr2/auto-orient/strip|imageView2/2/w/1200/format/webp)
...
项目地址：[https://github.com/sameersbn/docker-gitlab](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fsameersbn%2Fdocker-gitlab)
...
> 原文链接：[https://github.com/nordon-wang/markdowns/blob/master/%E6%8C%81%E7%BB%AD%E9%9B%86%E6%88%90%E4%B8%8E%E6%8C%81%E7%BB%AD%E9%83%A8%E7%BD%B2/%E7%AC%94%E8%AE%B0.md](https://links.jianshu.com/go?to=https%3A%2F%2Fgithub.com%2Fnordon-wang%2Fmarkdowns%2Fblob%2Fmaster%2F%E6%8C%81%E7%BB%AD%E9%9B%86%E6%88%90%E4%B8%8E%E6%8C%81%E7%BB%AD%E9%83%A8%E7%BD%B2%2F%E7%AC%94%E8%AE%B0.md)



作者：ioufev
链接：https://www.jianshu.com/p/6bcb2853fae2
来源：简书
